...
var install = function install(Vue) {
  ...
  Vue.prototype.$antd = {
    ...
    $info: _modal2['default'].info,
    $success: _modal2['default'].success,
    $error: _modal2['default'].error,
    $warning: _modal2['default'].warning,
    $confirm: _modal2['default'].confirm
  };
};
